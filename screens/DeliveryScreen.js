    ...
    return (
        <View className='bg-[#00CCBB] flex-1'>
            <SafeAreaView className='z-50'>
                ...
                {/* Location error */}
                {locationError && (
                    <View className="bg-red-500 p-3 rounded-lg mx-5 mt-3">
                        <Text className="text-white text-center">{locationError}</Text>
                    </View>
                )}
            ...
            <View className='bg-white px-4 py-2 flex-row justify-between items-center'>
                <View className='flex-row space-x-3 items-center'>
                    <Image source={{ uri: 'https://media.licdn.com/dms/image/C4D03AQGp4-ZOASJhew/profile-displayphoto-shrink_400_400/0/1662927303975?e=1686787200&v=beta&t=Ff49XQJVHJePs3eKejwpJmlcH2qeTOEMsE3MXif_yE4' }} className='h-14 w-14 rounded-full' />
                    <View>
